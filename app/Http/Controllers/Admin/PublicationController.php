...
{
    /**
     * Show the create form (custom view).
     */
    ...
    /**
     * Store a new publication (custom, hybrid file handling).
     */
    ...
    /**
     * Show the edit form (custom view).
     */
    ...
    /**
     * Show a single publication (custom read view).
     */
    ...
    /**
     * Store the uploaded file through StorageController (hybrid S3/local) and
     * return the JSON value saved in the `file` column. Keeps the current value
